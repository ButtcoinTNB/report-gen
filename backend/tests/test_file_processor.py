...
class TestFileProcessor:
    ...
    def test_get_mime_type(self):
        ...
        assert FileProcessor.get_mime_type("test.docx") == "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
    ...
    def test_get_file_extension(self):
        ...
        assert FileProcessor.get_file_extension("application/vnd.openxmlformats-officedocument.wordprocessingml.document") == ".docx"
    ...
    def test_safe_path_join(self):
        ...
        assert FileProcessor.safe_path_join(base_dir, "subdir", "file.txt") == "/test/base/dir/subdir/file.txt"
        
        # Test with parent directory reference, should sanitize
        path = FileProcessor.safe_path_join(base_dir, "../file.txt")
        assert path == "/test/base/dir/file.txt" or path.endswith("file.txt")  # Different systems may handle this differently
