...
class TaskUpdateRequest(BaseModel):
    ...
    stage: Optional[ProcessStage] = Field(default=None, description="New stage of the task")
    ...
    report_id: Optional[str] = Field(default=None, description="ID of the generated report")
    estimated_time_remaining: Optional[int] = Field(default=None, description="Estimated time remaining in seconds")
    quality: Optional[float] = Field(default=None, ge=0, le=100, description="Quality score (0-100)")
    iterations: Optional[int] = Field(default=None, ge=0, description="Number of iterations performed")
    can_proceed: Optional[bool] = Field(default=None, description="Whether the user can proceed to the next step")
