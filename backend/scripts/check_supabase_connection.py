...
def check_supabase_connection():
    ...
    print(f"✅ Supabase Key: {settings.SUPABASE_KEY[:5]}...{settings.SUPABASE_KEY[-5:] if len(settings.SUPABASE_KEY) > 10 else ''}")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if response.status_code == 404:
                ...
                print("You may need to create it first. Try running the init_supabase.py script.")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("You can now run upload-reference-reports.py to upload your PDF templates.")
    else:
        print("\n❌ Supabase connection failed.")
        print("Please check your credentials in the .env file and try again.")
        print("Make sure you've created a reference_reports table in your Supabase database.") 