...
/**
 * Proxy route for report generation requests
...
export default async function handler(
  ...
  try {
    ...
    const backendUrl = `${config.API_URL}/api/generate/generate`;
    console.log(`Forwarding generate request to: ${backendUrl}`);
    ...
    console.error('Error forwarding generate request:', error instanceof Error ? error.message : String(error));
