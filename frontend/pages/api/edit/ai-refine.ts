...
/**
 * Proxy route for AI report refinement requests
...
export default async function handler(
  ...
  try {
    ...
    const backendUrl = `${config.API_URL}/api/edit/ai-refine`;
    console.log(`Forwarding AI refine request to: ${backendUrl}`);
    ...
    console.error('Error forwarding AI refine request:', error instanceof Error ? error.message : String(error));
